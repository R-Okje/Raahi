...
<html lang="en">
  <head>
    ...
    <title>Raahi - Decentralized Application</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to Raahi - The Supply Chain DAPP</h4>
            <p style="max-width: 80%;">
            Raahi is a Decentralized E2E Logistics Application that stores the whereabouts of product at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and get complete information about the provenance of that product hence empowering consumers to only purchase authentic and quality products.
            </p>
